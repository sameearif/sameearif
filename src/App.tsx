      ...
      <div className='app-container'>
        ...
        {page === "about" && (
          <div className="about-page">
            <p>I am Samee Arif, a 1st year Ph.D in Computer Science student at University of Michigan working under <a className='inplace' href="https://web.eecs.umich.edu/~mihalcea/" target="_blank">Dr. Rada Mihalcea</a>.</p>
