        ...
        {page === "publications" && (
          <div className={`about-page ${isTopLayout ? "visible" : ""}`}>
            ...
            <ul style={{ listStyleType: 'square', padding: 0, fontSize: '1em' }}>
              <li style={{ marginLeft: '15px', marginTop: '15px' }}><b>Samee Arif</b>, Muhammad Saad Haroon, Aamina Jamal Khan, Taimoor Arif Agha Ali Raza, Awais Athar, "<a className="inplace" href="https://aclanthology.org/2026.eacl-srw.25/" target="_blank" rel="noopener noreferrer">The Art of Storytelling: Multi-Agent Generative AI for Dynamic Multimodal Narratives</a>", in <em>SRW EACL 2026</em>.</li>
              ...
              <li style={{ marginLeft: '15px', marginTop: '15px', marginBottom: '50px' }}><b>Samee Arif</b>, Sualeha Farid, Awais Athar, Agha Ali Raza, "<a className="inplace" href="https://aclanthology.org/2024.lrec-main.1497/" target="_blank" rel="noopener noreferrer">UQA: Corpus for Urdu Question Answering</a>", in <em>LREC-COLING</em>, 2024.</li>
            </ul>
            <p>Preprints</p>
            <hr />
            <ul style={{ listStyleType: 'square', padding: 0, fontSize: '1em' }}>
