      ...
      <div className='app-container'>
        ...
        {page === "about" && (
          <div className="about-page">
            <p>I am Samee Arif, a first-year Computer Science and Engineering Ph.D. student at the <a className='inplace' href="https://cse.engin.umich.edu/academics/graduate/graduate-programs/phd-in-cse/" target="_blank">University of Michigan, Ann-Arbor</a> advised by <a className='inplace' href="https://web.eecs.umich.edu/~mihalcea/" target="_blank">Prof. Rada Mihalcea</a>. My research focuses on <em>adversarial robustness, societal alignment, and explainability</em> of large language models.</p>
            ...
            <p>When free, I create digital art, listen to Urdu music, read books, and play <a className='inplace' href="https://zelda.nintendo.com/breath-of-the-wild/" target="_blank">The Legend of Zelda: Breath of The Wild</a>.</p>
          </div>
        )}
