      ...
      <div className='app-container'>
        ...
        {page === "about" && (
          <div className="about-page">
            <p>I am Samee Arif, a first-year Computer Science and Engineering Ph.D. student at the <a className='inplace' href="https://cse.engin.umich.edu/academics/graduate/graduate-programs/phd-in-cse/" target="_blank">University of Michigan, Ann-Arbor</a> advised by <a className='inplace' href="https://web.eecs.umich.edu/~mihalcea/" target="_blank">Prof. Rada Mihalcea</a>. My research interests are in <b>Natural Language Processing</b> specifically in <em>LLM Reasoning</em> and <em>AI Safety</em>.</p>
            ...
            <p>Currently I am working on using LLM Jailbreaking techniques to investigate the phenomenon of "Shallow Safety Alignment". My research focuses on demonstrating how current safety mechanisms which often rely heavily on the probability distribution of the first few generated tokens can be bypassed through "Prefilling Attacks" that force the model into a compliant state. I am actively developing and testing novel training objectives to create models that remain robust even when their initial refusal barriers are breached.</p>
            <p>When free, I paint using watercolors, create digital art, listen to Urdu music, write <a className='inplace' href="https://dumplings.sameearif.com/" target="_blank">NLP blog</a>, work on my <a className='inplace' href="https://www.stardewvalley.net/" target="_blank">Stardew Valley</a>-inspired game, and play <a className='inplace' href="https://zelda.nintendo.com/breath-of-the-wild/" target="_blank">The Legend of Zelda: Breath of The Wild</a>.</p>
          </div>
        )}
        ...
        {page === "experience" && (
          <div className="about-page">
            ...
            <p style={{ marginTop: '-15px', fontSize: '1em' }}>I mentored 250+ students and taught topics including linear regression, unsupervised learning, and deep learning as a teaching assistant.</p>
        ...
        {page === "publications" && (
          <div className="about-page">
            ...
            <ul style={{ listStyleType: 'square', padding: 0, fontSize: '1em' }}>
              <li style={{ marginLeft: '15px' }}><b>Samee Arif</b>*, Sualeha Farid*, Abdul Hameed Azeemi, Awais Athar, Agha Ali Raza, "<a className='inplace' href="https://aclanthology.org/2025.gem-1.4/" target="_blank">The Fellowship of the LLMs: Multi-Agent Workflows for Synthetic Preference Optimization Dataset Generation</a>" in <em>GEM2 Workshop at the Association for Computational Linguistics (ACL)</em>, July 27-August 1, Vienna, Austria. 2025.</li>
              <li style={{ marginLeft: '15px', marginTop: '15px' }}><b>Samee Arif</b>, Aamina Jamal Khan, Mustafa Abbas, Agha Ali Raza, Awais Athar, "<a className='inplace' href="https://aclanthology.org/2025.coling-main.397/" target="_blank">WER We Stand: Benchmarking Urdu ASR Models</a>", in <em>The 31st International Conference on Computational Linguistics (COLING)</em>, January 19-24, Abu Dhabi, UAE. 2025.</li>
