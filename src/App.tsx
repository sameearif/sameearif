        ...
        {page === "publications" && (
          <div className="about-page">
            ...
            <ul style={{ listStyleType: 'square', padding: 0, fontSize: '1em' }}>
              <li style={{ marginLeft: '15px' }}><b>Samee Arif</b>*, Sualeha Farid*, Abdul Hameed Azeemi, Awais Athar, Agha Ali Raza, "<a className='inplace' href="https://arxiv.org/abs/2408.08688" target="_blank">The Fellowship of the LLMs: Multi-Agent Workflows for Synthetic Preference Optimization Dataset Generation</a>" in <em>GEM2 Workshop at the Association for Computational Linguistics (ACL)</em>, July 27-August 1, Vienna, Austria. 2025.</li>
